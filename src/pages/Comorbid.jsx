...
import Map_Combo from "../components/Combo_Map";
const Comorbid = (props) => {
  const logout = () => {
    localStorage.clear();
  ...
  const genderDataURL = `http://localhost:4300/get/Count/covid/combodata/${props.stateResidence}/genderwise`;
  const ageDataURL = `http://localhost:4300/get/Count/covid/combodata/${props.stateResidence}/agewise`;
  const DistrictDataURL = `http://localhost:4300/get/Count/covid/combodata/${props.stateResidence}/distwise`;
  useEffect(() => {
  ...
  return (
    ...
    <div className="state-chart-container" style={{position:"relative", top: "100px"}}>
      <div className="title text-[40px] pt-2 lg:text-[33px] font-bold leading-tight mt-8 page-title justify-center"><h2>State-Wise Comorbid Data</h2></div>
